...
$lllPrefix = 'LLL:EXT:hio_typo3_connector/Resources/Private/Language/habilitation.xlf:';

return [
    'ctrl' => [
        'title' => $lllPrefix . 'tx_hiotypo3connector_domain_model_habilitation',
        'label' => 'title',
        'hideAtCopy' => true,
        'hideTable' => false,
    ...
    'columns' => [
        ...
        'object_id' => [
            'exclude' => true,
            'label' => $lllPrefix . 'tx_hiotypo3connector_domain_model_habilitation.object_id',
            'config' => [
                'type' => 'input',
                'size' => 60,
                'max' => 255,
        ...
        'title' => [
            'label' => $lllPrefix . 'tx_hiotypo3connector_domain_model_habilitation.title',
            'config' => [
                'type' => 'input',
                'size' => 60,
                'max' => 255,
